    ...
    def make_instance(self, include_optional) -> PromptResponse:
        ...
        if include_optional:
            return PromptResponse(
                ...
                text = '',
                parts = [
                    verbatim_client.models.prompt_part.PromptPart(
                        start = 56, 
                        end = 56, 
                        index = 56, 
                        kind = 'doc', )
                ...
                document = [
                    verbatim_client.models.prompt_document_attachment.PromptDocumentAttachment(
                        id = '', 
                        text = '', 
                        pages = [
                            56
                ...
                web = [
                    verbatim_client.models.prompt_web_attachment.PromptWebAttachment(
                        id = '', 
                        text = '', 
                        title = '', 
                        url = '', )
