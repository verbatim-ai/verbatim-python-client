...
class TestPageCrawler(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PageCrawler:
        """Test PageCrawler
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageCrawler`
        """
        model = PageCrawler()
        if include_optional:
            return PageCrawler(
                items = [
                    verbatim_client.models.crawler.Crawler(
